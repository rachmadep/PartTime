        ...
        <div class="login">
            ...
            <div class="login__block toggled" id="l-login">
                ...
                <div class="login__block__body">
                    Daftar sebagai pencari kerja PartTime
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} form-group--float form-group--centered">
                        ...
                        <div class="form-group">
                          ...
                          <div class="">
                            Sudah Punya Akun?<a class="btn-link-login" href="{{ route('login') }}">
                                Login
                            </a>
                          </div>
                        </div>
