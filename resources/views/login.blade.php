            ...
            <div class="login__block toggled" id="l-login">
                ...
                <div class="login__block__body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group--float form-group--centered form-group--centered form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">E-Mail Address</label><i class="form-group__bar"></i>
                        ...
                        <div class="form-group--float form-group--centered form-group--centered form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Password</label><i class="form-group__bar"></i>
